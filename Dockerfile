...
RUN apt-get install -y qmlscene qt5-qmake qt5-default qtdeclarative5-dev qtdeclarative5-localstorage-plugin qml-module-qtqml-models2 qtdeclarative5-qtmultimedia-plugin qtdeclarative5-window-plugin
