...
RUN cd /opt && mkdir qt-build-5.3 && mkdir qt-5.3 && cd qt-build-5.3 && /tmp/qt-everywhere-opensource-src-5.3.2/configure -opensource -confirm-license -qt-xcb  -prefix /opt/qt-5.3 && cd ../qt-build-5.3 && make && make install
