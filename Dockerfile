...
RUN cd /opt && mkdir qt-build-5.6 && mkdir qt-5.6 && cd qt-build-5.6 && /tmp/qt-everywhere-opensource-src-5.6.0/configure -opensource -confirm-license -qt-xcb  -gstreamer -prefix /opt/qt-5.6 && make && make install
